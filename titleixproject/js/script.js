...
function populateContent(data){
  contentParts = {
    ...
    "filled" : data.haveyoueverfiledanincidentreporttotheuclatitleixoffice,
    "reportyesno" : data.haveyoueverbeeninasituationwhereyoufeltyoumayneedtofileanincidentreporttotheuclatitleixoffice,
    "location" : data.whereoncampusdidyouexperienceissueswarrantinghelpundertitleix,
    "disc" : data.undertitleixhowwouldyouclassifytheincidentsituationexperiencedoncampusfiledornotdiscriminationbasedon
  }
...
function changeDesc(obj){
  ...
  document.getElementById("filled").innerHTML=(obj.filled != "") ? ("\"" + obj.filled + "\"") : "No response was provided.";
  document.getElementById("reportyesno").innerHTML=(obj.reportyesno != "") ? ("\"" + obj.reportyesno + "\"") : "No response was provided.";
  document.getElementById("location").innerHTML=(obj.location != "") ? ("\"" + obj.location + "\"") : "No response was provided."
  document.getElementById("disc").innerHTML=(obj.disc != "") ? ("\"" + obj.disc + "\"") : "No response was provided."
}
